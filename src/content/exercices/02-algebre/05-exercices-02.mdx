...
```sql wrap
R1 = (VILLE : (NOMVILLE = "Lyon"))
R2 = (R1 (R1.CODEPOSTAL = CINEMA.CODEPOSTAL) x CINEMA)
R3 = (R2 (R2.NUMCINE = SALLE.NUMCINE ∧ SALLE.CAPACITE  100) x SALLES)
```
</details>
...
R3 = (R2 (R2.NUMSALLE = SALLE.NUMSALLE) x SALLE
R4 = (R3 (R3.NUMCINE = CINEMA.NUMCIN E) x CINEMA
R5 = (R4 (R4.CODEPOSTAL = CILLE.CODEPOSTAL) x VILLE
R6 = R5[NOMCINE, ADRESSE, NOMVILLE]
```
</details>
