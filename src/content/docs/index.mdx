...
<Slide title="Introduction aux bases de données (BDD)">

:::note[Objectif de ce cours]
**Se former à l'utilisation et à la conception des Bases de Données**
:::
...
Ce cours est concu pour être suivi sur 2 semestres. 

Cependant, il est possible de suivre uniquement le premier semestre qui est une introduction aux bases de données relationnelles.
