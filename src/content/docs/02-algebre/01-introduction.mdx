...
* Règles de construction des opérateurs ou **axiomes**
    * Axiomes pour `+`, `x` (_associativité, commutativité, distributivité, etc._)
...
:::danger[Il existe 2 notations pour l'algèbre relationnelle !]

    * avec des symboles mathématiques ( `π`, `σ`, `⍴` ) (Pi, Sigma, Rho) 
    * ou bien une notation textuelle utilisant le nom des relations et des caractères `[]`, `()`, `x`, `:`, `ET`, `OU`, etc.

Les deux sont correctes, vous pouvez utiliser celle que vous préférez. La notation textuelle est plus simple à écrire sur ordinateur...
:::
