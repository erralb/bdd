...
Téléchargez la base de données à utiliser pendant le TP : [bazard.sqlite](/bdd/public/bazar.sqlite)

1. Ouvrez SQLite Studio
2. Cliquez sur `Fichier` > `Ouvrir la base de données`
3. Sélectionnez le fichier `bazard.sqlite` téléchargé précédemment
