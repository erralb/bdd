...
_Si ce n'est pas déjà fait, installez [SQLite Studio](https://sqlitestudio.pl/) et ouvrez la base de données [bazar.sqlite](/bdd/public/bazar.sqlite) pour tester vos requêtes._
