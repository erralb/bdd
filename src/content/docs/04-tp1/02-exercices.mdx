...
_Si ce n'est pas déjà fait, installez [SQLite Studio](https://sqlitestudio.pl/) et ouvrez la base de données [bazard.sqlite](/bdd/public/bazar.sqlite) pour tester vos requêtes._
...
Sauvegardez vos requêtes SQL dans **un seul fichier** `.sql` puis soumettez-le sur Moodle.
