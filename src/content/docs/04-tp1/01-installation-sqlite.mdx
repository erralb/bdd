...
<Tabs>
  <TabItem label="Linux">
  * Fichier précompilé pour Linux : [sqlite-tools-linux-x64-3460100.zip (1.99 MiB)](https://www.sqlite.org/2024/sqlite-tools-linux-x64-3460100.zip)
  * Via le gestionnaire de paquets de votre distribution :
  ...
  <TabItem label="MacOS">
    ...
    * Avec [le fichier précompilé pour MAC](https://www[.sqlite.org/download.html) actuellement [sqlite-tools-osx-x64-3460100.zip (3.55 MiB)](https://www.sqlite.org/2024/sqlite-tools-osx-x64-3460100.zip)
  ...
  <TabItem label="Windows">
    * Avec [le fichier précompilé pour Windows](https://www.sqlite.org/download.html) actuellement [https://www.sqlite.org/2024/sqlite-dll-win-x64-3460100](https://www.sqlite.org/2024/sqlite-dll-win-x64-3460100.zip)
  </TabItem>
</Tabs>
...
:::danger[Attention]
En mode interactif sans ouvrir de base de données, les données sont stockées en mémoire et sont perdues à la fermeture du terminal.
:::
