...
:::danger[Attention]
Les onglets d'éditeurs de requêtes En SQLite Studio ne sont pas automatiquement sauvegardés. Pensez à sauvegarder vos requêtes dans un fichier `.sql` pour les retrouver plus tard.
:::
