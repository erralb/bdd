...
:::tip[Définition]
La normalisation d'une relation est la décomposition d'une relation est le **remplacement** d'une relation R **par un ensemble de relations** R1,...,Rn tel que :
...
* La colonne _Nom_ n'est pas atomique (elle contient le prénom et le nom)
