...
* Dans notre exemple précédent, il existe une contrainte entre les colonnes _isbn_, _titre_ et _auteur_ de la table LIVRES
* On notera :
    * ISBN → TITRE, AUTEUR 
...
:::note[Pour éviter le phénomène de redondance]
