...
<table>
  ...
  <tr>
    <td>321</td>
    <td>Vincent Bouvier</td>
    <td>
      53, rue Emmanuelle Monnier
      <br />
      02510 Lombard-sur-Leleu
    </td>
  </tr>
</table>
