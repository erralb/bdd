...
Si vous voulez tester les exemples, vous pouvez [installer MySQL sur votre machine](https://dev.mysql.com/downloads/installer/) ou utiliser un service en ligne comme [db-fiddle](https://www.db-fiddle.com/).
...
Comme pour les triggers, on changer le délimiteur pour définir une procédure stockée.
