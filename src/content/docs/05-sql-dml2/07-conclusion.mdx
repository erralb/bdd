...
* Les bases de données au format SQLite présentées dans le cours sont disponibles pour tester les requêtes :
  * _[Clients](https://drive.google.com/file/d/12TxOXIlS41hMe5E5C_6cevzuyXhaM5sf/view?usp=sharing)_  (exemple fil rouge du cours)
  * _[Personnes](https://drive.google.com/file/d/1ctY3S2cJb-zp7ybTbo1F9QfbWsMmOIWI/view?usp=sharing)_  (requêtes cycliques)
