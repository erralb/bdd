...
FROM Clients
WHERE ville = 'Leclercq' ;
```

Cette requête SQL sélectionne les valeurs `numero`, `nom`, `ville` des lignes de la table `Clients` et ne conserve que les lignes qui vérifient la condition `ville = 'Leclercq'` . 

<Table
  sqliteDB="public/sample/ecommerce/ecommerce-fr-erd-v2.sqlite"
  title="Clients"
  query="SELECT numero, nom, ville FROM Clients WHERE ville = 'Leclercq' ;"
/>
...
<Table
  sqliteDB="public/sample/ecommerce/ecommerce-fr-erd-v2.sqlite"
  title="Clients"
  query="SELECT ville FROM Clients WHERE ville = 'Leclercq' ;"
/>
</Slide>
<Slide>
...
FROM Clients WHERE ville = 'Leclercq' ;
```

<Table
  sqliteDB="public/sample/ecommerce/ecommerce-fr-erd-v2.sqlite"
  title="Clients"
  query="SELECT DISTINCT ville FROM Clients WHERE ville = 'Leclercq' ;"
/>
