...
```sql
SELECT numero, nom, ville FROM Clients where ville = 'Leclercq' ;
```
...
```sql
SELECT ville FROM Clients where ville = 'Leclercq' ;
```
...
```sql
SELECT distinct ville FROM Clients where ville = 'Leclercq' ;
```
